...
const User = require("./models/user");            // ← Import User model for wipe
const app = express();
    ...
    await User.updateMany(
      {},
      {
        $set: {
          ...
          solPendingBalance: 0,
          btcPendingBalance: 0,
          usdtPendingBalance: 0,
          usdcPendingBalance: 0,
          ethPendingBalance: 0,
          bnbPendingBalance: 0,
          dogePendingBalance: 0,
          maticPendingBalance: 0,
          avaxPendingBalance: 0,
          ngnzPendingBalance: 0,
